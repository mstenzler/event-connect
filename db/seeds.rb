...
users = User.create([ { display_name: "Mike1", email: "mike1@example.com", password: "foobar", password_confirmation: "foobar"},
  ...
  { display_name: "Anne", email: "anne@example.com", password: "foobar", password_confirmation: "foobar"},
  { display_name: "Anne2", email: "anne2@example.com", password: "foobar", password_confirmation: "foobar"},
  { display_name: "Anne3", email: "anne3@example.com", password: "foobar", password_confirmation: "foobar"},
  { display_name: "Anne4", email: "anne4@example.com", password: "foobar", password_confirmation: "foobar"},
